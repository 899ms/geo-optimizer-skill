---
title: "MCP Server: GEO Tools for Claude, Cursor"
description: "Run GEO Optimizer as a Model Context Protocol server so Claude Code, Cursor and Windsurf can audit sites. Install, tools, resources and config."
order: 18
---
