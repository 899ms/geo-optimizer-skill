---
title: "Schema Injector (geo schema): JSON-LD for AI"
description: "Add JSON-LD structured data with the geo schema command: supported types, framework outputs, inline HTML injection and schema templates for AI search."
order: 5
---
