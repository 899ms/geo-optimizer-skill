---
title: "AI Context Files: Platform-Ready Setup"
description: "Platform-specific AI context files for ChatGPT, Claude, Gemini and Perplexity with per-platform format and character limits. Setup reference."
order: 19
---
