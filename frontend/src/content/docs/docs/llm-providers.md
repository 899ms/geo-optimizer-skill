---
title: "geo citations: LLM Providers & API Setup"
description: "Configure API keys and regional endpoints for geo citations. Supported providers, model capabilities, wire formats and rate limits."
order: 17
---
