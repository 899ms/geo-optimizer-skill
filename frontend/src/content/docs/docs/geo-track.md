---
title: "GEO Track Command: Scheduled AI Audits"
description: "Run recurring, tracked AI-visibility audits with geo track and keep local history. CLI reference: schedule, history, and re-audit workflows."
order: 10
---
