---
title: "Troubleshooting: Common GEO CLI Errors"
description: "Fix installation and runtime issues: geo command not found, Python version problems, fetch errors, sitemap failures and proxy/timing errors."
order: 20
---
