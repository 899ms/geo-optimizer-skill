---
title: "geo llms Command: Generate /llms.txt From Sitemap"
description: "Generate an /llms.txt file automatically from your XML sitemap. Full CLI reference: flags, sitemap auto-detection, sections, and the llms-full.txt companion."
order: 4
---
