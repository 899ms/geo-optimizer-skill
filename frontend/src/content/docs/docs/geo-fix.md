---
title: "GEO Fix Command: Generate robots.txt, llms.txt"
description: "The geo fix command audits a URL and generates robots.txt, llms.txt, JSON-LD schema, meta tags, AI-discovery files and content rewrite guidance in one shot."
order: 3
---
